...
const TaskEditForm = ({ tempID, openEditModal, setOpenEditModal, editValue, setEditValue, handleFocus, handleEdit }) => {
  ...
  return (<>
    <input className="modal-state" id="modal-edit" type="checkbox" onChange={() => setOpenEditModal(!openEditModal)} checked={openEditModal} />
